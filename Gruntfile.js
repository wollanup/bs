module.exports = function (grunt) {
    ...
    grunt.registerMultiTask('i18next', 'Add translation bundles to Bs.Lang', function () {
        let that = this, len = this.filesSrc.length, lang, outputDir, outputFile, originalFile, destFile, merged;
        ...
        let iterateTroughFiles = function (abspath, rootdir, subdir, filename) {
            ...
            originalFile = '+function(){Bs.Lang.addResourceBundle(\'' + lang + '\', \'' + ns + '\', ' +
                JSON.stringify(originalFile) + ')}();';
